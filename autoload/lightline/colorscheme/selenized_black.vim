" =============================================================================
" Filename: autoload/lightryanline/colorscheme/selenized_black.vim
" Author: itchyny
" License: MIT License
...
let g:lightryanline#colorscheme#selenized_black#palette = lightryanline#colorscheme#flatten(s:p)
