...
function! s:suite.custom()
  ...
  let g:lightryanline = { 'component_expand': { 'custom': 'Custom' } }
  call lightryanline#init()
...
function! s:suite.custom_type()
  ...
  let g:lightryanline = { 'component_expand': { 'custom': 'Custom' }, 'component_type': { 'custom': 'custom' } }
  call lightryanline#init()
  call s:assert.equals(s:expand([['readonly', 'filename'], ['custom'], ['modified']]),
...
function! s:suite.raw_type()
  ...
  let g:lightryanline = { 'component_expand': { 'custom': 'Custom' }, 'component_type': { 'custom': 'raw' } }
  call lightryanline#init()
  call s:assert.equals(s:expand([['readonly', 'filename'], ['custom'], ['modified']]),
...
function! s:suite.component_raw()
  ...
  let g:lightryanline = { 'component_expand': { 'custom': 'Custom' }, 'component_type': { 'custom': 'custom' }, 'component_raw': { 'custom': 1 } }
  call lightryanline#init()
  call s:assert.equals(s:expand([['readonly', 'filename'], ['custom'], ['modified']]),
...
function! s:suite.notfound()
  let g:lightryanline = { 'component_expand': { 'custom': 'NotFound' } }
  call lightryanline#init()
  call s:assert.equals(s:expand([['readonly', 'filename'], ['custom'], ['modified']]),
        \ [[['readonly', 'filename'], [], ['modified']], [[0, 0], [], [0]], ['0', '1', '2', '3']])
  call s:assert.equals(s:expand([['readonly', 'filename', 'custom', 'modified']]),
...
function! s:suite.custom_type_notfound()
  let g:lightryanline = { 'component_expand': { 'custom': 'NotFound' }, 'component_type': { 'custom': 'custom' } }
  call lightryanline#init()
  call s:assert.equals(s:expand([['readonly', 'filename'], ['custom'], ['modified']]),
        \ [[['readonly', 'filename'], [], ['modified']], [[0, 0], [], [0]], ['0', '1', '2', '3']])
  call s:assert.equals(s:expand([['readonly', 'filename', 'custom', 'modified']]),
...
function! s:suite.duplicated_string()
  ...
  let g:lightryanline = { 'component_expand': { 'custom': 'Custom', 'modified': 'Modified' } }
  call lightryanline#init()
...
function! s:suite.dictionary_function()
  let g:lightryanline = { 'component_expand': { 'custom': 'g:lightryanline.Custom' } }
  function! g:lightryanline.Custom()
    return [ ['left'], ['middle'], ['right'] ]
  endfunction
  call lightryanline#init()
  call s:assert.equals(s:expand([['readonly', 'filename'], ['custom'], ['modified']]),
